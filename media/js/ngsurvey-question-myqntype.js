(function(global, $) {
	...
	var module = NgSurveyApi.MyQnTypeQuestion = {};

	/**
	 * Function loaded on the load of main question form and attaches all event handlers to DOM.
	 */
    module.initForm = function() {
		$('#ngs').off('click', '.qtype-myqntype .btn-add-answer');
		$('#ngs').on('click', '.qtype-myqntype .btn-add-answer', function() {
		...
		$('#ngs').off('click', '.qtype-myqntype .btn-remove-answer');
		$('#ngs').on('click', '.qtype-myqntype .btn-remove-answer', function() {
